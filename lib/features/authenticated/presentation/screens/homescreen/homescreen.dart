import 'package:FoodNutrient/core/utils/common.dart';
import 'package:FoodNutrient/features/authenticated/presentation/screens/homescreen/widgets/article_section.dart';
import 'package:FoodNutrient/features/authenticated/presentation/screens/homescreen/widgets/category_item.dart';
import 'package:FoodNutrient/features/authenticated/presentation/screens/homescreen/widgets/greeting.dart';
      ...
      body: SafeArea(
        child: ListView(
          children: [
            SizedBox(height: 5.h),
            Greeting(
              name: AppLocalizations.of(context)!.costTitle,
            ),
            ArticleSection(
